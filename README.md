...
- **Event-Driven (Apache Kafka)** : communication asynchrone entre Spring Boot et FastAPI via un broker Kafka, avec supervision des topics via Provectus Kafka UI : [doc Kafka](https://github.com/messaoudRm/movieapp-kafka-event-driven/blob/feature/kafka-kraft/README.md)
...
%% ==== SECTION BACKEND ====
  subgraph Backend["Backend Services"]
    ...
    subgraph KafkaBroker["Apache Kafka KRaft (container)"]
      direction TB
    end
